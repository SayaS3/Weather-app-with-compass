...
import com.studioartagonist.weather.databinding.FragmentWeatherBinding
...
import com.studioartagonist.weather.network.getFormattedDate
import com.studioartagonist.weather.network.icon_prefix
import com.studioartagonist.weather.network.icon_suffix
import com.studioartagonist.weather.prefs.WeatherPreference
...
class WeatherFragment : Fragment() {
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        if(item.itemId == R.id.item_compass){
            requireActivity().run{
    ...
    private fun setCurrentData(it: CurrentWeatherModel) {
        ...
        binding.pressureTV.text = it.main.pressure.toString() + "hPa"
        binding.windTV.text = "13" + " km/h"
